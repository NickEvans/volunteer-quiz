...
var Quiz = function () {
    ...
    this._showResult = function () {
        ...
        $resultBox.html("<h1 class='mb-4'><p>Here is your result!</p> <p>You matched with <u>" + ORGINFO[resultList[0]].name + "</u></p> </h1> <p>" + ORGINFO[resultList[0]].info + '<a class="my-3 mx-auto btn btn-primary btn-lg text-center" href="' + ORGINFO[resultList[0]].link + '" target="_blank"><strong>Visit Website</strong></a></p>');
